    ...
    <html>
      ...
      <body>
        ...
        <div className="section">
          ...
          <div className="row"><span className="label">Fecha de ingreso</span><span className="value">{formatDateShort(orden.fechaIngreso)}</span></div>
          <div className="row"><span className="label">Fecha prometida</span><span className="value">{formatDateShort(orden.fechaPrometida)}</span></div>
        </div>
